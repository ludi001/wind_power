...
let Comps = React.createClass({
    getInitialState(){
        ...
        return{
            ...
            yColor:newobj.detail!=undefined?newobj.detail.yColor:'#000000',
    ...
    componentDidMount() {
        ...
        compsDetail.colorselect('box1','#fff')
        compsDetail.colorselect('box2','#000')
    ...
    render () {
        ...
        let {yColor,datasourse,left,top,distance,title,height,width,unit,color,color1}=this.state;
        ...
        return (
            <div className={styles.mainBox} id='allbox'>
                ...
                <label>文字颜色:</label><input id='box2' className={styles.colorselect} defaultValue={yColor} onChange={this.handleChange6}     data-theme={'yColor'}  onBlur={()=> setCompsDetail(compsList, activeComps)}  />
            </div>
        )
    }
})
